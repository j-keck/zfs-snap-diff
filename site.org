...
issue, contact me per mail (see my github profile), or [[https://keybase.io/jkeck][keybase.io]].
{{< /hint >}}
...
You can download the latest binary package from here or from the [[https://github.com/j-keck/zfs-snap-diff/releases][GitHub release page]].
 ...
 #+BEGIN_SRC elisp :results output raw :exports results
   (defun version-string ()
       ...
       (s-trim-right (shell-command-to-string "git describe --tags --match 'v[0-9].[0-9].[0-9]'")))
...
[[https://github.com/j-keck/zfs-snap-diff/compare/0.0.10...1.0.0][all commits from 0.0.10...1.0.0]]
